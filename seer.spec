...
Version  : 1.13
Release  : 6
URL      : https://github.com/epasveer/seer/archive/v1.13/seer-1.13.tar.gz
Source0  : https://github.com/epasveer/seer/archive/v1.13/seer-1.13.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670507447
pushd src
mkdir -p clr-build
pushd clr-build
