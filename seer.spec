...
Version  : 2.5
Release  : 11
URL      : https://github.com/epasveer/seer/archive/v2.5/seer-2.5.tar.gz
Source0  : https://github.com/epasveer/seer/archive/v2.5/seer-2.5.tar.gz
...
%prep
%setup -q -n seer-2.5
cd %{_builddir}/seer-2.5
pushd ..
cp -a seer-2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735439057
pushd src
mkdir -p clr-build
pushd clr-build
