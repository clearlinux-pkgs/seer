...
Version  : 2.4
Release  : 10
URL      : https://github.com/epasveer/seer/archive/v2.4/seer-2.4.tar.gz
Source0  : https://github.com/epasveer/seer/archive/v2.4/seer-2.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710860549
pushd src
mkdir -p clr-build
pushd clr-build
