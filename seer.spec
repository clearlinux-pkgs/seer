...
Version  : 1.11
Release  : 5
URL      : https://github.com/epasveer/seer/archive/v1.11/seer-1.11.tar.gz
Source0  : https://github.com/epasveer/seer/archive/v1.11/seer-1.11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664233478
pushd src
mkdir -p clr-build
pushd clr-build
