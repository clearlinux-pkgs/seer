...
Version  : 1.10
Release  : 4
URL      : https://github.com/epasveer/seer/archive/v1.10/seer-1.10.tar.gz
Source0  : https://github.com/epasveer/seer/archive/v1.10/seer-1.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663083370
pushd src
mkdir -p clr-build
pushd clr-build
