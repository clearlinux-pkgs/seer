...
Version  : 1.14
Release  : 7
URL      : https://github.com/epasveer/seer/archive/v1.14/seer-1.14.tar.gz
Source0  : https://github.com/epasveer/seer/archive/v1.14/seer-1.14.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672694936
pushd src
mkdir -p clr-build
pushd clr-build
